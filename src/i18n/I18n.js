...
switch (languageCode) {
  ...
  case 'uk':
    ...
    break
  case 'vn'://vietnam
    I18n.translations.vn = require('./languages/vi.json')
    break
  case 'cn':// china
    I18n.translations.cn = require('./languages/zh.json')
    break
  case 'zu':
    I18n.translations.zu = require('./languages/zu.json')
    break
  case 'lo': // Lao
    I18n.translations.lo = require('./languages/lo.json')
    break
}
