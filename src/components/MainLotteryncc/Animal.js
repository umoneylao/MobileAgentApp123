...
import { View, Text, StyleSheet, Image, FlatList, ScrollView, SafeAreaView, Modal, TouchableOpacity, Platform } from 'react-native';
...
class AnimalSreen extends Component {
    constructor(props) {
        super(props);
        this.state = {
            SwitchPag: "BUY_LOTTERY_ANIMAL",
            EvenSell: "SELL_LOTTERY_ANIMAL",
            ...
            <View style={{ width: '100%', height: 40, flexDirection: 'row', padding: 5, }}>
                ...
                <View style={{ width: '40%', justifyContent: 'center', alignItems: 'center', }}>
                    <View style={styles.itemColor}>
                        <Text style={styles.txtItemColor}>{item.RESULT_340}</Text>
                    </View>
                </View>
                <View style={{ width: '30%', justifyContent: 'center', alignItems: 'center', }}>
    ...
    render() {
        const { dateDraw, detaStart, imageOne, imageTwo, imageThree, getDrewHistory } = this.props
        return (
                    ...
                    <View style={styles.cardStyle}>
                        <View style={styles.imgaeBox}>
                            ...
                            <View style={styles.txtgruop}>
                                ...
                                <Text style={styles.txtAnimal}>{I18n.t('Animal')}</Text>
                            </View>
                        </View>
                        <View style={styles.boxDate}>
                            <Text style={styles.txtAnimal}>{I18n.t('UpcomingDrawDate')}</Text>
                            <Text style={styles.txtNcclottery}>{detaStart || null}</Text>
                        </View>
                    </View>
                    <View style={styles.cardStyle}>
                        <View style={styles.groupTxt}>
                            ...
                            <View style={styles.txtWiner}>
                                ...
                                <Text>{I18n.t('Drawdate')}: {dateDraw || null}</Text>
                            </View>
                        </View>
                        <View style={styles.icAnimal}>
                            <TouchableOpacity style={styles.boxAnimal} onPress={() => this.onSwich()} >
                                <Image source={imageOne} style={styles.iconAnimal} />
                            </TouchableOpacity>
                            <TouchableOpacity style={styles.boxAnimal} onPress={() => this.onSwich()}>
                                <Image source={imageTwo} style={styles.iconAnimal} />
                            </TouchableOpacity >
                            <TouchableOpacity style={styles.boxAnimal} onPress={() => this.onSwich()}>
                                <Image source={imageThree} style={styles.iconAnimal} />
                            </TouchableOpacity>
                        </View>
                    </View>
