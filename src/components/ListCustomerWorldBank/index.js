                            ...
                            <TouchableOpacity onPress={() => onDisplay(item)}>
                                <Animated.View style={{
                                    ...
                                    <View style={styles.nameContainer}>
                                        <View style={{ width: '60%' }}>
                                            <Text style={styles.nameTxt} numberOfLines={1} ellipsizeMode="tail">{item.last_name ? item.last_name : null}</Text>
                                            <Text style={styles.nameTxt1} numberOfLines={1} ellipsizeMode="tail">{item.cct_id ? item.cct_id : null}</Text>
                                            <Text style={styles.msgTxt}>{moment(item.birthday).format('YYYY-MM-DD H:mm:ss')}</Text>

                                        </View>
                                        <View style={{ width: '40%', height: '100%', }}>
                                            <View style={{ flexDirection: 'row', justifyContent: 'center', alignItems: 'center', flex: 1 }}>
                                                <Text style={styles.msgTxt1}>{formatNumber(item.balance.toString())} ₭</Text>
