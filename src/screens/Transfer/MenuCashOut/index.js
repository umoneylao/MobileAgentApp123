...
import { menuCashOut, menuCashOutRole7 } from '../../../models/MenuApp'
import * as Animatable from 'react-native-animatable';
import { connect } from 'react-redux'
class MenuCashOut extends Component {
    constructor(props) {
        super(props);
        this.state = {
            isAgent: false
    ...
    render() {
        ...
        return (
            <SafeAreaView style={{ flex: 1, backgroundColor: Colors.white}}>
                ...
                <FlatList
                    data={isAgent ? menuCashOut : menuCashOutRole7}
...
export default connect(mapStateToProps, mapDispatchToProps)(MenuCashOut);
