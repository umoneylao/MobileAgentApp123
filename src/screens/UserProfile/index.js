...
import {
  ...
  NativeModules, AsyncStorage, Platform, SafeAreaView,Linking
} from 'react-native'
...
class UserProfile extends Component {
  ...
  renderInner = () => (
    <View style={styles.panel}>
      <View style={{ alignItems: 'center' }}>
        <Text style={styles.panelTitle}>{I18n.t('addPhoto')} 123</Text>
  ...
  render() {
    ...
    return (
        ...
        <ScrollView>
          <View>
            <LinearGradient
              ...
              <ImageBackground source={Images.bg_headerAccout} style={{ width: imageWidh, height: imageHeigh, marginTop: 0 }}>
                {
                  infoAccount != null ? (
                    <View style={styles.viewHeader}>
                      <Text style={{ color: '#FFF', marginBottom: 10, fontSize: 20, fontWeight: 'bold' ,marginTop:40}}>{I18n.t('MyAccount')}</Text>
                      ...
                      <Text style={styles.textName}>{infoAccount.customerName} - {infoAccount.agentCode}</Text>
                      <Text style={styles.textPhone}>{infoAccount.phoneNumber}</Text>
                    </View>
                  ) : null
                }
      ...
      //                 }
      //               </TouchableOpacity>
      //               <Text style={styles.textName}>{infoAccount.customerName}</Text>
      //               <Text style={styles.textPhone}>{infoAccount.phoneNumber}</Text>
      //             </View>
      //           ) : null
      //         }
      ...
      //       />
      //       <View>
      //         <TouchableOpacity style={styles.viewMenuAccount} onPress={() => this.onLogout()}>
      //           <Image source={Images.ic_Logout} style={styles.iconMenuAccount} />
      //           <Text style={styles.textMenuAccount}>{I18n.t('signOut')}</Text>
      //         </TouchableOpacity>
      //       </View>
      //     </View>
      //   </Animated.View>
